 ...
 * design rests on an answer being checkable against the document, not trusted because a
 * model said it (phase 3.5's `verify_citation` checks the same quote in Python).
 */
